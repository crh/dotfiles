...
--
myWorkspaces = ["1:term","2:web","3:code","4:reading","5:media","6:chat","7:eclipse"] ++ map show [8..9]
...
myManageHook = composeAll
    ...
    , className =? "Firefox-trunk"  --> doShift "2:web"
    , className =? "Emacs"          --> doShift "3:code"
    , className =? "Gvim"           --> doShift "3:code"
    , className =? "gvim"           --> doShift "3:code"
    , className =? "Evince"         --> doShift "4:reading"
    , resource  =? "Evince"         --> doShift "4:reading"
    , className =? "okular"         --> doShift "4:reading"
    , resource  =? "okular"         --> doShift "4:reading"
    , className =? "Pidgin"         --> doShift "6:chat"
    , className =? "Skype"          --> doShift "6:chat"
    , className =? "Xchat"          --> doShift "6:chat"
    , className =? "VirtualBox"     --> doShift "4:reading"
    ...
    , resource  =? "smplayer"       --> doShift "5:media"
    , resource  =? "pidgin"         --> doShift "6:chat"
