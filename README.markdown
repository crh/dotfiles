...
prejudiced mix: Linux, vim, emacs, sublime, zsh, git, Ruby. If you
...
committing as crh. You probably don't want that.
...
[open an issue](https://github.com/crh/dotfiles/issues) on this repository
